...
// const ValidateOrderDialog = ({ open, onOpenChange, orderNumber, onConfirm }: ValidateOrderDialogProps) => {
...
//         description: `La commande ${orderNumber} a été validée et mise en traitement`
//       });
//       onOpenChange(false);
//       setPriority('normal');
//       setNotes('');
...
//             Valider la commande {orderNumber}
//           </DialogTitle>
//         </DialogHeader>

//         <div className="space-y-4 py-4">
//           <div className="space-y-2">
//             <Label htmlFor="priority">Priorité de traitement</Label>
...
//           <div className="space-y-2">
//             <Label htmlFor="notes">Notes de traitement (optionnel)</Label>
//             <Textarea
//               id="notes"
...
//                   <li>Notification client par email</li>
//                   <li>Génération du bon de préparation</li>
//                   <li>Mise à jour du stock</li>
//                 </ul>
//               </div>
//             </div>
//           </div>
