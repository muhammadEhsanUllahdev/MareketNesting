...
// const RefundOrderDialog = ({ open, onOpenChange, orderNumber, totalAmount, onConfirm }: RefundOrderDialogProps) => {
...
//     { value: 'defective_item', label: 'Produit défectueux' },
//     { value: 'wrong_item', label: 'Mauvais article expédié' },
//     { value: 'damaged_shipping', label: 'Endommagé pendant la livraison' },
//     { value: 'late_delivery', label: 'Livraison trop tardive' },
//     { value: 'duplicate_order', label: 'Commande en double' },
//     { value: 'fraud_prevention', label: 'Prévention fraude' },
...
//         description: "Veuillez sélectionner une raison pour le remboursement",
//         variant: "destructive"
//       });
//       return;
//     }
...
//         description: "Le montant doit être entre 0 et le total de la commande",
//         variant: "destructive"
//       });
//       return;
//     }
...
//         description: `Remboursement de ${amount.toLocaleString('fr-FR', { style: 'currency', currency: 'EUR' })} en cours de traitement`
//       });
//       onOpenChange(false);
//     } catch (error) {
//       toast({
//         title: "Erreur",
//         description: "Impossible d'initier le remboursement",
//         variant: "destructive"
//       });
//     } finally {
//       setIsLoading(false);
...
//               Montant à rembourser (Max: {totalAmount.toLocaleString('fr-FR', { style: 'currency', currency: 'EUR' })})
//             </Label>
//             <Input
//               id="amount"
//               type="number"
...
//                 <p>Le remboursement sera traité sous 3-5 jours ouvrés. Cette action ne peut pas être annulée.</p>
//               </div>
//             </div>
//           </div>
//         </div>
...
//             {isLoading ? "Traitement..." : `Rembourser ${amount.toLocaleString('fr-FR', { style: 'currency', currency: 'EUR' })}`}
//           </Button>
//         </DialogFooter>
//       </DialogContent>
//     </Dialog>
...
const RefundOrderDialog = ({
  ...
  //       title: t("refundDialog.success.title"),
  //       description: t("refundDialog.success.description", {
  //         amount: amount.toLocaleString('fr-FR', { style: 'currency', currency: 'EUR' })
  //       })
  //     });
  //     onOpenChange(false);
  //   } catch (error) {
  //     toast({
  //       title: t("refundDialog.error.title"),
  //       description: t("refundDialog.error.description"),
  //       variant: "destructive"
  //     });
  //   } finally {
  //     setIsLoading(false);
