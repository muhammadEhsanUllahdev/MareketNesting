...
//                       All your products are sufficiently stocked for now.
//                     </p>
//                   </div>
//                 ) : (
...
//                     </h3>
//                     <p className="text-gray-600">
//                       Resolved alerts will appear here once you solve active
//                       alerts.
//                     </p>
//                   </div>
//                 ) : (
...
export default function StockAlertsPage() {
  ...
  const importantAlerts = alerts.filter((alert) => alert.alertType === "important");
  const mediumAlerts = alerts.filter((alert) => alert.alertType === "medium");
  const activeAlerts = alerts.filter((alert) => alert.status === "active");
  const resolvedAlerts = alerts.filter((alert) => alert.status === "resolved");
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <p className="text-sm text-gray-600">{t("alerts.important")}</p>
                  <p className="text-2xl font-bold text-orange-600">
                    {importantAlerts.length}
                  </p>
                </div>
          ...
          <Card>
            <CardContent className="p-6">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  <p className="text-sm text-gray-600">{t("alerts.totalActive")}</p>
                  <p className="text-2xl font-bold">{activeAlerts.length}</p>
                </div>
              </div>
            </CardContent>
