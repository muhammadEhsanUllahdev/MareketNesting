...
//         description:
//           "Veuillez confirmer correctement votre nouveau mot de passe.",
//         variant: "destructive",
//       });
//       return;
//     }
...
//   return (
//     <DashboardLayout title="Paramètres de la boutique">
...
//                 </div>
//                 <Button
//                   onClick={() => updateSellerProfileMutation.mutate(formData)}
//                 >
...
//                       <p className="text-sm text-muted-foreground">
//                         Alertes quand le stock est faible
//                       </p>
//                     </div>
//                     <Switch defaultChecked />
//                   </div>
