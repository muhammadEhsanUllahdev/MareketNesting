...
export function ProductViewModal({
  ...
  useEffect(() => {
    if (product?.images?.length > 0) {
      setSelectedImage(product.images[0]); // ✅ show first image as default
    } else {
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            {t("products.completeInformation")}
          </DialogDescription>
        </DialogHeader>
          ...
          <div className="space-y-6">
            <div className="mb-6">
              <div className="flex items-center gap-2 mb-4">
                ...
                <div className="flex bg-gray-100 rounded-lg p-1">
                  {SUPPORTED_LANGS.map((lang) => {
                    const langLabels = {
                      en: t("products.english"),
                      fr: t("products.french"),
                      ar: t("products.arabic"),
                    };
                    return (
                      <button
                        key={lang}
            ...
            <div>
              ...
              <div className="text-gray-600 space-y-1">
                ...
                <p>
                  {t("products.sku")}: {product.sku} • {t("products.brand")}:{" "}
                  {product.brand}
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-gray-600">
                {product.stock} {t("products.unitsAvailable")}
              </span>
            </div>
            ...
            <Card>
              ...
              <CardContent>
                <p className="text-gray-700 font-medium">
                  {product.vendorName || t("products.storeOwner")}
                </p>
              </CardContent>
            </Card>
          </div>
